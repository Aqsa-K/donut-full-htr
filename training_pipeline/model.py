...
def verify_dataset(added_tokens, processor, data_set):
    ...
    pixel_values, labels, target_sequence = data_set[0]
...
train_dataset = DonutDataset("AqsaK/1880_census_handwritten_archives", max_length=max_length,
...
val_dataset = DonutDataset("AqsaK/1880_census_handwritten_archives", max_length=max_length,
                             split="train", task_start_token="<s_arch-v1>", prompt_end_token="<s_arch-v1>",
                             sort_json_key=False, # cord dataset is preprocessed, so no need for this
                             )


verify_dataset(added_tokens, processor, train_dataset)
verify_dataset(added_tokens, processor, val_dataset)
...
if __name__ == '__main__':
    ...
    # Run your training pipeline or verify_batch here
    # verify_batch(train_dataloader)


    verify_batch(train_dataloader)
    verify_batch(val_dataloader)

print("train_dataloader and val_dataloader created successfully")
...
if __name__ == '__main__':
    ...
    print("model_module created successfully")
...
if __name__ == '__main__':
    ...
    print("wandb_logger created successfully")
